...
const AuthModal = ({ onClose }: AuthModalProps) => {
  ...
  const enableEmailAuth = import.meta.env.VITE_ENABLE_EMAIL_AUTH !== 'false';
      ...
      >
        ...
        {showEmailAuth ? (
          ...
          <div className="space-y-3">
            ...
            {/* Divider - only show if email auth is enabled and other methods exist */}
            {enableEmailAuth && (enableTwitterAuth || enableGoogleAuth || enableSiwe) && (
