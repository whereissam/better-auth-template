...
const GoogleIcon = forwardRef<GoogleIconHandle, GoogleIconProps>(
  (
    { onMouseEnter, onMouseLeave, className, size = 24, duration = 1, isAnimated = true, disabled = false, ...props },
    ref,
  ) => {
    ...
    const blue = disabled ? "#ccc" : "#4285F4";
    const green = disabled ? "#ccc" : "#34A853";
    const yellow = disabled ? "#ccc" : "#FBBC05";
    const red = disabled ? "#ccc" : "#EA4335";
